               ...
               <ul class="nav navbar-nav">
                  ...
                  <?php if($_SESSION['ADMIN_ROLE']!=0){?>
				   <li class="menu-item-has-children dropdown">
                     <a href="mechanicdetails.php"> Mechanic DETAILS </a>
                  </li>
				  <li class="menu-item-has-children dropdown">
				  ...
				  <li class="menu-item-has-children dropdown">
                     <a href="showservice.php" > SERVICE DETAILS </a>
                  </li>
                  <li class="menu-item-has-children dropdown">
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="index.php"><img src="images/logofinal.png" alt="Logo" height="50" width="90"></a>
                  <a class="navbar-brand hidden" href="index.php"><img src="logofinal.png" alt="Logo"></a>
