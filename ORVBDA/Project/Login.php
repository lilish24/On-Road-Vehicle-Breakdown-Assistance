...
<div id="myForm">
  <form  class="form-container" method="post"  action = "authentication.php " onsubmit = "return validation()"style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); float:right; margin-right:   5%;margin-top:  5%;margin-bottom:   5%; border:none;    " >
    <h1>Login</h1>
    ...
    <button type="button" class="btn RegistrationForm" name=notregister><a href="uregform.php" style="color: white;text-decoration: none;">Dont have Account?RegisterNow</a></button>
